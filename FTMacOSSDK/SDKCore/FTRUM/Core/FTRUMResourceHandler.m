...
- (void)writeResourceData:(FTRUMDataModel *)data{
    ...
    [[FTSDKAgent sharedInstance] rumWrite:FT_MEASUREMENT_RUM_RESOURCE terminal:FT_TERMINAL_APP tags:tags fields:fields tm:[FTDateUtil dateTimeNanosecond:self.time]];
}
@end
